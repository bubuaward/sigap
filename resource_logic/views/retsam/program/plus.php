						...
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									...
									<select id="category" name="category_id" class="form-control" data-validation="required"></select>
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<select id="geography" name="geography_id" class="form-control" data-validation="required"></select>
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<select id="location" name="location_id" class="form-control" data-validation="required"></select>
								</div>
							</div>
