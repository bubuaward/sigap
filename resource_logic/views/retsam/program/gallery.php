			...
			if($list){
				foreach($list AS $no => $red){
					echo '<div class="col-sm-3">
						<div class="box box-success">
							<div class="box-body">
								<h5><a href="'.base_url(DIRADMIN.'/program/media_delete/'.auto_url($red->media_id)).'" class="label label-danger pull-right">delete</a>'.($no+1).'] '.($red->video ? 'Video':'Image').($red->copyright ? '<br/> &#169; '.$red->copyright : '').'</h5>
