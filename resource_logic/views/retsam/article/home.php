...
$(document).ready(function() {
	$('#datatablemaster').DataTable( {
		...
		"order": [[ 2, "desc" ]],
		'sAjaxSource': "<?php echo base_url(DIRADMIN.'/article/ajax_master_datatable'); ?>",
		"columns": [
			{ "data": "image" },
			{ "data": "title" },
			{ "data": "created" },
...
<div class="content-wrapper">
	...
	<section class="content-header clearfix">
		...
		<a href="<?php echo base_url(DIRADMIN.'/article/plus');?>" class="btn btn-success btn-sm pull-right" target="_self"><i class="fa fa-plus-circle"></i> Add Data</a></h1>
	</section>
