				...
				<div class="box box-success">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input name="video" class="form-control" type="text" placeholder="xYT2XXXXX" onChange="return youtubegetid(this, event);" data-validation="required">
						</div>
						<div class="form-group">
			...
			if($list){
				foreach($list AS $no => $red){
					echo '<div class="col-sm-3">
						<div class="box box-success">
							<div class="box-body">
								<h5><a href="'.base_url(DIRADMIN.'/about/media_delete/'.auto_url($red->media_id)).'" class="label label-danger pull-right">delete</a>'.($no+1).'] '.($red->video ? 'Video':'Image').'</h5>
