				...
				<div class="box box-success">
					<div class="box-body">
						...
						foreach($language AS $red){
							echo form_hidden('slider_id_'.$red->language_slug, $translate[$red->language_slug]['slider_id']);
							...
							echo '<div class="well well-sm">';
								...
								<div class="form-group">
									...
									<input value="'.(isset($translate[$red->language_slug]) ? $translate[$red->language_slug]['location'] : '').'" name="location_'.$red->language_slug.'" class="form-control" type="text" onKeyPress="return textsonly(this, event)" data-validation="required">
								</div>
								<div class="form-group">
									<label>Description</label>
									<textarea name="description_'.$red->language_slug.'" class="form-control" type="text" onKeyPress="return textsonly(this, event)" data-validation="required">'.(isset($translate[$red->language_slug]) ? $translate[$red->language_slug]['description'] : '').'</textarea> 
								</div>';
							echo '</div>';
						}
						?>
						...
						<div class="form-group">
							...
							<input value="<?php echo $detail->url;?>" name="url" class="form-control" type="text" data-validation="required">
						</div>
						<div class="form-group">
							<label>Ordered</label>
							<input value="<?php echo $detail->ordered;?>" name="ordered" class="form-control" type="text" onKeyPress="return numbersonly(this, event)" data-validation="required">
						</div>
						...
						<div class="form-group">
							...
							<?php
							echo '<p><img width="200px" class="img-responsive" src="'.base_url('storage/homeslider/'.$detail->cover).'"></p>';
