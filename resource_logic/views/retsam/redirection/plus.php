					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input name="from_url" class="form-control" type="text" data-validation="required custom length" data-validation-regexp="^([a-zA-Z0-9_\-]+)$" data-validation-length="2-100">
							</div>
						</div>
						
						<div class="form-group">
							<label>Redirect to URL</label>
							<input name="to_url" class="form-control" type="text" data-validation="required length" data-validation-length="max255">
						</div>
