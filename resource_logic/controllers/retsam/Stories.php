...
class Stories extends ST_Controller {
	...
	public function home()
	{
		...
		$this->display(array('main_header','stories/home','main_footer'), $data, 0);
	}
	...
	public function plus()
	{
		...
		$this->display(array('main_header','stories/plus','main_footer'), $data, 0);
	}
	...
	public function edit($slug = null)
	{
		...
		$this->display(array('main_header','stories/edit','main_footer'), $data, 0);
	}
	...
	public function media($slug = null)
	{
		...
		$this->display(array('main_header','stories/gallery','main_footer'), $data, 0);
	}
	...
	public function ajax_master_datatable()
	{
		...
		$this->datatables->where('content_type', 'stories');
		...
		foreach($data->aaData AS $red){
			...
			$action = '<div class="text-center">
				<a href="'.base_url(DIRADMIN.'/stories/media/'.$red->actions).'" class="btn bg-black btn-xs btn-block" target="_self"><i class="fa fa-image"></i> Gallery</a>
				<a href="'.base_url(DIRADMIN.'/stories/edit/'.$red->actions).'" class="btn bg-orange btn-xs btn-block" target="_self"><i class="fa fa-edit"></i> Edit</a>
				<a href="'.base_url(DIRADMIN.'/stories/featured/'.$red->actions).'" class="btn bg-green btn-xs btn-block" target="_self"><i class="fa fa-star"></i> '.($red->is_featured == 'featured' ? 'UnFeatured' : 'Featured').'</a>
				<a onClick="return checkedbutton(\''.base_url(DIRADMIN.'/stories/hide/'.$red->actions).'\')" href="javascript:;" class="btn bg-red btn-xs btn-block"><i class="fa fa-flag"></i> '.($red->published == 'publish' ? 'Unpublish' : 'Publish').'</a>
			</div>';
			...
			foreach($lang AS $sub){
				$html .= '<a href="'.base_url($sub->language_slug.'/sejarah/'.$red->slug).'" target="_blank">'.$sub->title.'</a>
					<br/>
